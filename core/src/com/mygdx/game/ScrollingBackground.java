...
public class ScrollingBackground {
    ...
    public ScrollingBackground () {
        ...
        imageScale = Boot.INSTANCE.widthScreen / image.getWidth();
        speedFixed = true;
    }
    ...
    public void updateAndRender (float deltaTime, SpriteBatch batch) {
        ...
        //Render
        batch.draw(image, 0, y1, Boot.INSTANCE.widthScreen, image.getHeight() * imageScale);
        batch.draw(image, 0, y2, Boot.INSTANCE.widthScreen, image.getHeight() * imageScale);
    }
